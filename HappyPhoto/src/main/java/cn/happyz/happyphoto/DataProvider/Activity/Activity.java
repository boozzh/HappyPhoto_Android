...
public class Activity {
    ...
    public int getDocumentChannelId() {
        return DocumentChannelId;
    }

    public void setDocumentChannelId(int documentChannelId) {
    ...
    public void setActivityClassId(int activityClassId) {
    ...
    public void setIsGroupPic(int isGroupPic) {
        IsGroupPic = isGroupPic;
    }
